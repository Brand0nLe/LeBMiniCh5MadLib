...
//Peer Review: Mark Ramirez - ok works great the validation for entry's works the story is nice however the restart function need to be fixed 
//it says try again if i put in a WORD other than yes or no however if i put a number it starts again.
